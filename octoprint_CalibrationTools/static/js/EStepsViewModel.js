    ...
    function CalibrationToolsEStepsModelView(parameters) {
        ...
        self.startExtrusion = function () {
            ...
            OctoPrint.simpleApiCommand("CalibrationTools", "eSteps_startExtrusion", {
                ...
                self.generalVM.notifyWarning("E-Steps calibration started", "<span style='font-weight:bold; color: red;'>Nozzle heating has started!!!</span><br> When extrusion stops you will have to fill <b>Length after extrusion</b> and save the new value ")
